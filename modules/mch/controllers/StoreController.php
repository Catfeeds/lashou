...
class StoreController extends Controller
{
    ...
    {
//        $parent1Member = User::find()->where('`level` >= 1 AND `parent_id` = 503444')->asArray()->all();
...
//        }
//        var_dump($fens1);
//        var_dump($fens2+$fens1);die;
        //$dataAnMeiLa = $this->request_checkAnMeiLaAccounts(['uid'=>,'pwd'=>]);
//        $partner = User::find()->where(['is_partner'=>1,'mobile'=>null,'is_delete'=>0])->asArray()->all();
//        var_dump($partner);die;
    ...
    public function actionSetting()
    {
        if (\Yii::$app->request->isPost) {
            ...
            $form->store_id = $this->store->id;
           // $form->after_profit_time = \Yii::$app->request->post('after_profit_time');
