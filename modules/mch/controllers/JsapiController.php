...
$mchid = '1487254152';          //微信支付商户号 PartnerID 通过微信支付商户资料审核后邮件发送
$appid = 'wxed5e81eb334526fa';  //微信支付申请对应的公众号的APPID
$appKey = '7bbe363458cfbc8bb2220642a3366be4';   //微信支付申请对应的公众号的APP Key
$apiKey = 'Ao1wBKmSUy4LRmFWp0L6EhlgjpwhC92G';   //https://pay.weixin.qq.com 帐户设置-安全设置-API安全-API密钥-设置API密钥
//①、获取用户openid
$wxPay = new JsapiController($mchid,$appid,$appKey,$apiKey);
...
$orderName = '支付测试';    //订单标题
$notifyUrl = "http://lashou.oioos.com/web/source/member/notify_url.ctrl.php";   //付款成功后的回调地址(不要有问号)
$payTime = time();      //付款时间
