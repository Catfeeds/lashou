...
class StoreSettingForm extends Model
{
    ...
    {
        return [
            [['name', 'markettime','app_id', 'app_secret', 'mch_id', 'key', 'order_send_tpl', 'contact_tel', 'copyright', 'copyright_pic_url', 'copyright_url', 'kdniao_mch_id', 'kdniao_api_key', 'address', 'cert_pem', 'key_pem', 'dial_pic', 'web_service', 'web_service_url','payment','wxapp'], 'trim'],
            ...
            [['show_customer_service', 'delivery_time', 'after_sale_time','after_profit_time', 'cat_style', 'cut_thread','purchase_frame','cat_goods_cols', 'over_day', 'is_offline', 'is_coupon', 'cat_goods_count', 'send_type', 'nav_count', 'integral', 'dial'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'markettime' => PARTNER_LABEL . '订单存放时间(时间)',
    ...
    public function save()
    {
        ...
        $store->markettime = $this->markettime;
        ...
        $store->after_profit_time = $this->after_profit_time;
