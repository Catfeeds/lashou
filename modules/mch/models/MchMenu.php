...
//                            ],
            ...
            [
                'admin' => true,
                'name' => PARTNER_LABEL . '管理',
                'route' => 'mch/partner/index',
                'icon' => 'icon-jiegou',
                'list' => [
                    [
                        'name' => '列表管理',
                        'route' => 'mch/partner/list',
                    ],
                    [
                        'name' => '订单市场',
                        'route' => 'mch/partner/market',
                    ],
                    [
                        'name' => '订单管理',
                        'route' => 'mch/partner/order',
                    ],
                    [
                        'name' => '提现管理',
                        'route' => 'mch/partner/cash',
                    ],
            /*        [
                        'name' => '设置',
                        'route' => 'mch/partner/basic',
                        'list' => [
                            [
                                'name' => '自定义设置',
                                'route' => 'mch/partner/custom'
                            ],
                        ]
                    ],*/
                ],
    ...
    private function resetList($list)
    {
        foreach ($list as $i => $item) {
            ...
            if (isset($item['partner']) && $item['partner'] && $this->platform != 'partner') {
                unset($list[$i]);
                continue;
            }
