                                    ...
                                    <table class="table table-bordered attr-table">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <div class="input-group">
                                                    <span>货号</span>
                                                    <input class="form-control form-control-sm" style="width: 30px">
                                                    <span class="input-group-addon"><a href="javascript:" class="bat"
                                        ...
                                        <tr v-for="(item,index) in checked_attr_list">
                                            ...
                                            <td>
                                                <input class="form-control form-control-sm" type="number" min="0"
                                                       step="1" style="width: 90px" v-bind:name="'attr['+index+'][num]'"
...
<!--                                                    |-->
<!--                                                    <a href="javascript:" class="down-attr-status" v-bind:data-index="index">下架</a>-->
<!--                                                </div>-->
<!--                                                <div v-else>-->
<!--                                                    <span class="badge badge-default">已下架</span>-->
<!--                                                    |-->
<!--                                                    <a href="javascript:" class="up-attr-status" v-bind:data-index="index">上架</a>-->
<!--                                                </div>-->
<!--                                                <input class="form-control form-control-sm" style="width: 100px" type="hidden"-->
<!--                                                       v-bind:name="'attr['+index+'][status]'" v-bind:data-index="index"-->
...
<script>
    ...
    $(document).on('click', '.down-attr-status', function () {

        var btn = $(this);
        var input = btn.parents('.input-group').find('.form-control');
        var index = btn.attr('data-index');

        page.checked_attr_list[index].status = 2;
    });
    $(document).on('click', '.up-attr-status', function () {

        var btn = $(this);
        var input = btn.parents('.input-group').find('.form-control');
        var index = btn.attr('data-index');
        //input.val('').trigger('change');
        page.checked_attr_list[index].status = 1;
    });
