...
<div class="panel mb-3">
    ...
    <div class="panel-body">
        <form method="post" class="auto-form">
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label"><?= PARTNER_LABEL?>暂存时间</label>
                </div>
                <div class="col-sm-6">
                    <div class="input-group">
                        <input class="form-control" type="number" name="markettime"
                               value="<?= $store->markettime ?>">
                        <span class="input-group-addon">小时(最大)</span>
                    </div>
                    <div class="text-muted fs-sm">超过该时间则自动放回订单市场</div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">收益时间</label>
                </div>
                <div class="col-sm-6">
                    <div class="input-group">
                        <input class="form-control" type="number" name="after_profit_time"
                               value="<?= $store->after_profit_time ?>">
                        <span class="input-group-addon">天</span>
                    </div>
                    <div class="text-muted fs-sm">可以申请售后的时间，<span class="text-danger">注意：分销订单中的已完成订单，只有订单已确认收货，并且时间超过设置的收益天数之后才计入其中！</span>
                    </div>
                </div>
            </div>
