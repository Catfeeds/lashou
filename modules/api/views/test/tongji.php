                        ...
                        <div class="mr-4">
                            <div class="form-group row w-20">
                                <div>
                                    ...
                                    >
                                        <a class="dropdown-item" href="<?= $urlManager->createUrl(['api/test/tongji','store_id'=>1]) ?>">普通订单</a>
                                        <a class="dropdown-item" href="<?= $urlManager->createUrl(['api/test/tongji','status' => 1,'store_id'=>1]) ?>">拼团订单</a>
                                        <a class="dropdown-item" href="<?= $urlManager->createUrl(['api/test/tongji','status' => 2,'store_id'=>1]) ?>">秒杀订单</a>
