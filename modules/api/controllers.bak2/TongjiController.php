...
//160000 修复 代理变合伙人
        public function actionPartner2(){
            set_time_limit(0);
            $query = User::find()->where(['and',['>','id',184999],['<','id',190000]])->andWhere(['is_partner'=>0])->asArray()->all();
    ...
    public function actionPartner3()
    {
        set_time_limit(0);
        $query = User::find()->where(['and', ['>', 'id', 176792], ['<', 'id', 200000]])->andWhere("is_partner is null")->asArray()->all();
        ...
        public function actionPartner4(){
            set_time_limit(0);
            $query = User::find()->where(['and',['>','id',179999],['<','id',185000]])->andWhere(['is_partner'=>0])->asArray()->all();
    ...
    public function actionPartner5(){
        set_time_limit(0);
        $query = User::find()->where(['and',['>','id',189999],['<','id',200000]])->andWhere(['is_partner'=>0])->asArray()->all();
