...
Page({
    ...
    onLoad: function (options) {
        ...
        if (!app.isLogin()){
          ...
          var isticket = options.isticket;
          if (isticket == 1 && user_id != '') {
            wx.navigateTo({
              url: "/pages/ls-toupiao-share/ls-toupiao-share?user_id=" + user_id + "",
            })
          }
          if (typeof options.redirect_bundle != 'undefined' && options.redirect_bundle == 1) {
            wx.navigateTo({
    ...
    gotoCategory:function(e){
      ...
      wx.navigateTo({
        url: '/pages/list/list?cat_id=' + catId,
      })
    },
