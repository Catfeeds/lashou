            ...
            function WechatPay(order_id, url, route) {
                app.request({
                    ...
                    success: function (res) {
                        ...
                        if (res.code == 0) {
                          var is216 = (!(typeof res.is_216 == "undefined" || res.is_216 == null) && res.is_216) ? true : false;
                            wx.requestPayment({
                                ...
                                complete: function (e) {
                                    ...
                                    if (e.errMsg == "requestPayment:fail" || e.errMsg == "requestPayment:fail cancel") {//支付失败转到待支付订单列表
                                      ...
                                      getApp().track("微信支付失败", null);
                                        return;
                                    }
                                    getApp().track("微信支付成功", null);
                                    if(is216){
                                      wx.redirectTo({
                ...
                app.request({
                    ...
                    success: function (res) {
                        if (res.code == 0) {
                            ...
                            function pay() {
                              console.log("wooran pay", pay_type);
                                app.request({
                                    url: url_pay_data,
                                    data: {
                                        order_id: order_id,
                                    ...
                                    success: function (res) {
                                        if (res.code == 0) {
                                            getApp().track("余额支付成功或货到付款成功", null);
                                            setTimeout(function () {
                                                wx.hideLoading();
                                            }, 1000);
                                            var is216 = (!(typeof res.is_216 == "undefined" || res.is_216 == null) && res.is_216) ? true : false;
                                          ...
                                          getApp().track("余额支付失败或货到付款失败", null);
                                            _this.page.showToast({
                                                title: res.msg,
                                                image: "/images/icon-warning.png",
                                            });
