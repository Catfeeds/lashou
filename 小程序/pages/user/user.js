...
Page({
        ...
        app.request({
            ...
            success: function (res) {
                if (res.code == 0) {
                  ...
                  if (typeof res.can_share_activity != 'undefined'){
                    page.setData({
                      can_share_activity: res.can_share_activity,
                    });
                  }
                }
  ...
  ,
    ...
    tapContact:function(){
      console.log("uc tapContact");
      app.track("在线客服", {'from':'用户中心'});
    },
    ...
    ucSetting:function(e){
      console.log("uc setting event is ", e);
      var page = this;
      wx.getUserInfo({
        success: function (res){
          console.log("get user info is ", res);
          wx.showLoading({
            title: '正在同步',
          });
          var params = {};
