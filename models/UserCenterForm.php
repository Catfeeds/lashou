        ...
        return [
            ...
            'menus' => [
                ...
                [
                    'id' => 'partner',
                    'name' => PARTNER_LABEL,
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/partner.png',
                    'open_type' => 'navigator',
                    'is_show' => 1,
                ...
                [
                    ...
                    'open_type' => 'navigator',
                    'is_show' => 1,
                    'url' => '/pages/hello/hellolashou',
                    'tel' => '',
                ],
                [
                    'id' => 'uc_id',
                    'name' => '我的ID',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/uc-id.png',
                    'open_type' => 'uc_id',
                    'is_show' => 1,
                    'url' => '/pages/hello/hellolashou',
                    'tel' => '',
                ...
                [
                    'id' => 'uc_setting',
                    'name' => '同步微信资料',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/uc-setting.png',
                    'open_type' => 'uc_setting',
                    'is_show' => 1,
                    'url' => '/pages/hello/hellolashou',
                    'tel' => '',
                ]
