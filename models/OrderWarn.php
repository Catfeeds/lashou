    ...
    public function notify()
    {
        ...
        try {
            ...
            if($order->partner_id>0){
                $partner = User::findOne(['id'=>$order->partner_id]);
                if(!empty($partner->mobile)){
                    $mobile = $partner->mobile;
                    $url = 'http://202.91.244.252/qd/SMSSendYD?usr=7426&pwd=DYkk@1595z&mobile='.$mobile.'&sms='.'%c4%fa%d3%d0%d0%c2%b5%c4%b6%a9%b5%a5%3a'.$order->order_no.'%c7%eb%d7%a2%d2%e2%b2%e9%ca%d5%5b%c0%ad%ca%d6%c6%bd%cc%a8%d0%a1%b3%cc%d0%f2%5d&extdsrcid=';
